defmodule StarkBank.DynamicBrcode.Rule do
  alias __MODULE__, as: Rule
  alias StarkBank.Utils.API

  @moduledoc """
  Groups DynamicBrcode.Rule related functions
  """

  @doc """
  The DynamicBrcode.Rule struct modifies the behavior of DynamicBrcode structs when passed as an argument upon their creation. Only the "allowedTaxIds" key is currently supported, and at most one rule is accepted.
