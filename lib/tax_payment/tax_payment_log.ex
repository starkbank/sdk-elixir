defmodule StarkBank.TaxPayment.Log do
  ...
  ## Options:
    ...
    - `:payment_ids` [list of strings, default null]: list of TaxPayment ids to filter retrieved structs. ex: ['5656565656565656', '4545454545454545']
    - `:user` [Organization/Project, default nil]: Organization or Project struct returned from StarkBank.project(). Only necessary if default project or organization has not been set in configs.
  ...
  def resource_maker(json) do
    %Log{
      id: json[:id],
      payment: json[:payment] |> API.from_api_json(&TaxPayment.resource_maker/1),
      errors: json[:errors],
      type: json[:type],
