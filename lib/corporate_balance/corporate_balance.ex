defmodule StarkBank.CorporateBalance do
  ...
  @doc """
  The CorporateBalance struct displays the current corporate balance of the Workspace,
  ...
  ## Attributes (return-only):
    ...
    - `:max_limit` [integer, default nil]: the maximum negative balance allowed by Stark Bank. ex: 100000 (= R$ 1000.00)
    - `:currency` [string, default nil]: currency of the current Workspace. Expect others to be added eventually. ex: "BRL"
    - `:updated` [DateTime, default nil]: latest update datetime for the CorporateBalance. ex: ~U[2020-03-26 19:32:35.418698Z]
  """
  defstruct [:id, :amount, :limit, :max_limit, :currency, :updated]
