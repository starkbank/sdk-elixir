defmodule StarkBank.DasPayment.Log do
  alias __MODULE__, as: Log
  alias StarkBank.Utils.Rest
  alias StarkBank.Utils.Check
  alias StarkBank.Utils.API
  alias StarkBank.DasPayment
  alias StarkBank.User.Project
  alias StarkBank.Error

  @moduledoc """
  Groups DasPayment.Log related functions
  """
  ...
  ## Options:
    ...
    - `:payment_ids` [list of strings, default nil]: list of DasPayment ids to filter retrieved entities. ex: ["5656565656565656", "4545454545454545"]
    - `:user` [Project]: Project struct returned from StarkBank.project(). Only necessary if default project has not been set in configs.
  ...
  def resource_maker(json) do
    %Log{
      id: json[:id],
      payment: json[:payment] |> API.from_api_json(&DasPayment.resource_maker/1),
