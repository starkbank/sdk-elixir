defmodule StarkBank.DasPayment do
  alias __MODULE__, as: DasPayment
  ...
  @moduledoc """
  Groups DasPayment related functions
  """
  ...
  Attributes (return-only):
    ...
    - `:fee` [integer, default nil]: fee charged when a DAS payment is created. ex: 200 (= R$ 2.00)
  ...
  @doc """
  Send a list of DasPayment structs for creation in the Stark Bank API

  ## Parameters (required):
    - `payments` [list of DasPayment structs]: list of DasPayment structs to be created in the API

  ## Options:
    - `:user` [Project]: Project struct returned from StarkBank.project(). Only necessary if default project has not been set in configs.

  ## Return:
    - list of DasPayment structs with updated attributes
  """
  @spec create([DasPayment.t() | map()], user: Project.t() | nil) ::
          {:ok, [DasPayment.t()]} | {:error, [Error.t()]}
  ...
  """
  @spec create!([DasPayment.t() | map()], user: Project.t() | nil) :: any
  def create!(payments, options \\ []) do
    Rest.post!(
      resource(),
      payments,
  ...
  @doc """
  Receive a single DasPayment struct previously created by the Stark Bank API by passing its id
  ...
  ## Return:
    - DasPayment struct with updated attributes
  """
  @spec get(binary, user: Project.t() | nil) :: {:ok, DasPayment.t()} | {:error, [%Error{}]}
  ...
  """
  @spec get!(binary, user: Project.t() | nil) :: DasPayment.t()
  def get!(id, options \\ []) do
    Rest.get_id!(resource(), id, options)
  end
  ...
  @doc """
  Receive a stream of DasPayment structs previously created in the Stark Bank API
  ...
  ## Return:
    - stream of DasPayment structs with updated attributes
  """
  @spec query(
          limit: integer,
  ...
  @spec query!(
          ...
          ({:cont, [DasPayment.t()]} | {:halt, any} | {:suspend, any}, any -> any)
  def query!(options \\ []) do
    Rest.get_list!(resource(), options)
  end
  ...
  """
  @spec delete(binary, user: Project.t() | nil) :: {:ok, DasPayment.t()} | {:error, [%Error{}]}
  ...
  """
  @spec delete!(binary, user: Project.t() | nil) :: DasPayment.t()
  def delete!(id, options \\ []) do
    Rest.delete_id!(resource(), id, options)
  end
