defmodule StarkBank.MerchantCategory do
  ...
  Attributes (return-only):
    - `:name` [string, default nil]: category's name. ex: "Veterinary services", "Fast food restaurants"
    - `:number` [string, default nil]: category's number. ex: "742", "5814"
  """
  defstruct [:code, :type, :name, :number]

  @type t() :: %__MODULE__{}

  @doc """
  Receive a stream of MerchantCategory structs previously registered in the Stark Bank API
