defmodule StarkBank.BrcodePayment.Log do
  ...
  @moduledoc """
  Groups BrcodePayment.Log related functions
  """
  ...
  ## Options:
    ...
    - `:payment_ids` [list of strings, default nil]: list of BrcodePayment ids to filter retrieved entities. ex: ["5656565656565656", "4545454545454545"]
    - `:user` [Organization/Project, default nil]: Organization or Project struct returned from StarkBank.project(). Only necessary if default project or organization has not been set in configs.
  ...
  ## Return:
    - list of BrcodePayment.Log structs with updated attributes and cursor to retrieve the next page of BrcodePayment.Log objects
  """
  @spec page(
          cursor: binary,
          limit: integer,
  ...
  def resource_maker(json) do
    %Log{
      id: json[:id],
      payment: json[:payment] |> API.from_api_json(&BrcodePayment.resource_maker/1),
