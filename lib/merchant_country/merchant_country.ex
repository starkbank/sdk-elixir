defmodule StarkBank.MerchantCountry do
  ...
  Attributes (return-only):
    ...
    - `:short_code` [string, default nil]: country's short code. ex: "BR"
  """
  @enforce_keys [:code]
  defstruct [:code, :name, :number, :short_code]

  @type t() :: %__MODULE__{}

  @doc """
  Receive a stream of MerchantCountry structs previously registered in the Stark Bank API
